...
const editCosmeticsExtraReducer = {
    ...
    [editCosmetics.fulfilled]: (state, action) => {
        ...
        if (existingCosmetics) {
            ...
            existingCosmetics.offer = offer
            existingCosmetics.availability = availability
            existingCosmetics.deliverydate = deliverydate
            existingCosmetics.daystodeliver = daystodeliver
            existingCosmetics.offerprice = offerprice
        }
        state.loading = false
    },
